...
<div class="widget-content widget-content-area br-8 p-5">
    ...
    <form class="row g-3" action="{{route('price.group.update', $price_group->id)}}" method="POST">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" value="{{ $price_group->name }}" placeholder="Enter Price Group Name">
