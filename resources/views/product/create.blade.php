        ...
        <form class="" action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="g-3 widget-content widget-content-area br-8 layout-top-spacing">
                    ...
                    <div class="col-md-3 col-12" id="hide_pur_price">
                        ...
                        <input type="text" class="form-control" id="purchase_price" name="purchase_price" placeholder="Cost Price">
                    ...
                    <div class="col-md-3 col-12" id="hide_sell_price">
                        ...
                        <input type="text" class="form-control" id="sell_price" name="sell_price" placeholder="Selling Price">
                        @error('sell_price')
                            <div class="error text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="col-md-4 col-12 mt-2">
                        ...
                        <input type="text" class="form-control" id="rack_no" name="rack_no" placeholder="Rack No"> 
                        @error('rack_no')
                            <div class="error text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-check form-check-primary form-check-inline">
                        <input class="form-check-input" type="radio" name="unit" id="unit1" value="1" checked>
                        <label class="form-check-label" for="unit1">
                            Piece
                        </label>
                    </div>
                    <div class="form-check form-check-info form-check-inline">
                        <input class="form-check-input" type="radio" name="unit" value="2" id="unit2">
                        <label class="form-check-label" for="unit2">
                            Kg
                        </label>
                    </div>
                    <div class="form-check form-check-success form-check-inline">
                        <input class="form-check-input" type="radio" name="unit" value="3" id="unit3">
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        ...
                        <textarea class="form-control" id="editor" name="description" placeholder="Descrption"></textarea>
                        @error('description')
                            <div class="error text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-12">
                        ...
                        <input type="text" class="form-control" id="alert_query" name="alert_query" placeholder="Alert Query">
                        @error('alert_query')
                            <div class="error text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <label for="address" class="form-label">Barcode Type <span class="text-danger">*</span></label>
                        <select class="form-select" id="barcode_type" name="barcode_type">
                            ...
                            <option value="4">Ena-8</option>
                            <option value="5">UPC-A</option>
                            ...
                            <div class="col-md-12 col-12"> 
                                <table class="table table-bordered mt-4" id="fallowupdate" style="display:none;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Sell Price <span class="text-danger">*</span></th>
                                            <th>Image</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="number" class="form-control text-end variant_purchase_price" id="variant_purchase_price" name="variant_purchase_price[]" placeholder="0.00">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-end variant_sell_price" id="variant_sell_price" name="variant_sell_price[]" placeholder="0.00">
                                        </td>
                                ...
                                <table class="table table-bordered mt-4" id="combofallupdate" style="display:none;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-end combo_quantity" id="combo_quantity" name="combo_quantity[]" value="1" placeholder="0">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-end combo_purchase_price" id="combo_purchase_price" name="combo_purchase_price[]" placeholder="0.00">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                            ...
                                            <th class="text-end">
                                                <input type="text" class="form-control text-end sub_total" id="sub_total" name="combo_purchase_price1" placeholder="0.00" readonly>
                                            </th>
                                        </tr>
                                        <tr>
        ...
        function addRow2() {
            var tr =  '<tr>'+
                '<td>'+
                    ...
                    '</select>'+
                '</td>'+
                '<td><input type="number" class="form-control text-end combo_quantity" id="combo_quantity" name="combo_quantity[]"  value="1" ></td>'+
